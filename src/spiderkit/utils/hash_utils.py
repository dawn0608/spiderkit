...
def _hash_text(algorithm: Callable[[], "hashlib._Hash"], text: str, output_format: str, error_label: str) -> Union[str, bytes]:
    try:
...
def md5(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 MD5 哈希值
...
def sha1(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA1 哈希值
...
def sha224(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA224 哈希值
...
def sha256(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA256 哈希值
...
def sha384(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA384 哈希值
...
def sha512(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA512 哈希值
...
def sha3_256(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 SHA3-256 哈希值
...
def blake2b(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 BLAKE2b 哈希值
...
def blake2s(text: str, output_format: str = "hex") -> Union[str, bytes]:
    """计算文本的 BLAKE2s 哈希值
